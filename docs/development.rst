...
authors pin dependency on ``sphinx_evas_theme`` to a version below the next major
version:

.. code:: console

    $ pip install "sphinx_evas_theme<2.0.0"
...
HTML4 support will be removed
    ...
    your dependency to ``sphinx_evas_theme<=3`` until you can.
